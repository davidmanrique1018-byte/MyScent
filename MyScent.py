...
# ==============================================================================
# DICCIONARIO Y FUNCIÓN DE GENERACIÓN DE NOMBRES
# ==============================================================================
COMPONENTES_NOMBRES = {
...
# ==============================================================================
# FUNCIÓN DEL TEST OLFATIVO (REUTILIZABLE)
# ==============================================================================
def render_test_olfativo():
...
# ==============================================================================
# CONTROL DE NAVEGACIÓN Y VISTAS (ADMIN VS CLIENTE)
# ==============================================================================
query_params = st.query_params
is_admin = query_params.get("admin") == "true" or "localhost" in st.context.headers.get("Host", "")

if is_admin:
    # SI ERES TÚ (Localhost o agregando ?admin=true a la URL): Muestra las 3 pestañas
    tab_test, tab_costos, tab_marca = st.tabs(["🌸 Test Olfativo", "📊 Simulación Financiera", "📍 Marca & Sede"])
    
    with tab_test:
        render_test_olfativo()
    ...
    with tab_costos:
        ...
        ml_base = tamano_ml - ml_esencia
        
        costo_total_esencia = ml_esencia * costo_esencia_ml
        costo_total_base = ml_base * costo_base_ml
    ...
    with tab_marca:
        ...
        with col_i1:
            st.markdown("""
            **Sede Principal:** 📍 **Centro Comercial Viva Barranquilla** Cra. 51B #87-50, Local 1-36  
            Barranquilla, Atlántico  
            
            **Horarios:** Lunes a Sábado: 10:00 a.m. – 8:00 p.m.  
            Domingos y Festivos: 11:00 a.m. – 6:00 p.m.
            """)
        with col_i2:
            st.markdown("""
            **Propuesta de Valor:** Perfumería personalizada en tiempo real impulsada por algoritmos de análisis de perfil para garantizar una fragancia única adaptada a la personalidad del cliente.
            """)

else:
    # SI ES UN CLIENTE EXTERNO: Solo renderiza el Test Olfativo directamente
    render_test_olfativo()